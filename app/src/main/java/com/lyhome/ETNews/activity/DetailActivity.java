...
public class DetailActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        mWebView = (WebView) findViewById(com.lyhome.ETNews.R.id.webview);
        mToolbar = (Toolbar) findViewById(com.lyhome.ETNews.R.id.toolbar);
        mProgressBar = (ProgressBar) findViewById(com.lyhome.ETNews.R.id.progressbar);
